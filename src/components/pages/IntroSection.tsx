...
export const IntroSection = () => {
  return (
    <section
      id="about"
      className="md:items-left relative flex h-full w-full flex-col items-center justify-center gap-7 overflow-x-clip overflow-y-visible bg-[#05050A] px-5 pt-30 text-center lg:px-40"
    >

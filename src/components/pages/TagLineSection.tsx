...
export const TaglineSection = () => {
  ...
  return (
    <section className="relative mx-auto mt-12 flex h-full w-fit flex-col items-center justify-center overflow-hidden rounded-[24px] border border-white/10 bg-[#05050A] py-12 text-center md:w-full md:max-w-[80vw] md:py-24">
